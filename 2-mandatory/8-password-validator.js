...
function validatePasswords(passwords) {
  return passwords.map((item, i) => item.length >=5 && containsUppercaseLetter(item) && containsLowercaseLetter(item)
  && containsNumber(item) && containsSymbol(item) && passwords.indexOf(item) === i);
}
